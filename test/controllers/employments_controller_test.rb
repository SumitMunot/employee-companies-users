...
class EmploymentsControllerTest < ActionController::TestCase
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post :create, employment: { company_id: @employment.company_id, manager: @employment.manager, staff: @employment.staff, user_id: @employment.user_id }
    end
  ...
  test "should update employment" do
    patch :update, id: @employment, employment: { company_id: @employment.company_id, manager: @employment.manager, staff: @employment.staff, user_id: @employment.user_id }
    assert_redirected_to employment_path(assigns(:employment))
  end
